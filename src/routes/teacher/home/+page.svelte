...
<main>
  ...
  <section class="teacher-dashboard" aria-labelledby="teacher-home-title">
    ...
    <section class="class-list" aria-label="Your classes">
      ...
      {:else}
        <div class="empty-classes"><span><Icon name="plus" size={22} /></span><h2>No classes yet</h2><p>Create your first class to help learners begin practicing math facts.</p><a class="button-link" href="/teacher/classes/new">Create a class <span><Icon name="arrow-right" size={16} /></span></a></div>
      {/if}
    </section>
  </section>
</main>
