// Inlined Lucide icons (https://lucide.dev, ISC license) — a single consistent
// stroke-based set so every glyph in the app matches. Values are the inner SVG
// of each 24×24 icon; Icon.svelte wraps them with the shared <svg> attributes.
export const icons = {
